...
def main():
    ...
    #DATA CLEANING-------------------------------------------------------------
    reader_gdp = csv.DictReader(open("data_dirty/gdp.csv", encoding='utf-8-sig'))
    reader_popgrowth= csv.DictReader(open("data_dirty/population_growth.csv", encoding='utf-8-sig'))
    reader_poptotal= csv.DictReader(open("data_dirty/population_total.csv", encoding='utf-8-sig'))
    reader_co2= csv.DictReader(open("data_dirty/co2_emission.csv", encoding='utf-8-sig'))
    reader_elec = csv.DictReader(open("data_dirty/electric_sources.csv",encoding='utf-8-sig'))
